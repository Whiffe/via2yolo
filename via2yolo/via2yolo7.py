...
python via2yolo7.py --via_Dataset  ./SCB5_jpg2/ --yolo_Dataset ./SCB-extend-R --tain_r 0.8 --behavior_av_id 1
python via2yolo7.py --via_Dataset  ./SCB5_jpg2/ --yolo_Dataset ./SCB-extend-D --tain_r 0.8 --behavior_av_id 2
...
parser.add_argument('--behavior_av_id', default='1', type=str)
...
behavior_av_id = arg.behavior_av_id
...
def via2yolo(json, root):
    ...
    for i in json['metadata']:
        ...
        if behavior_av_id in json['metadata'][i]['av'].keys():
            try:
                action_id = json['metadata'][i]['av'][behavior_av_id]
                # if action_id == '3':
                #     action_id = '0'
                # else:
                #     continue
